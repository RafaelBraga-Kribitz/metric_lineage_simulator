...
This project keeps TypeScript under `driver_tree_studio/` and Python governance
scripts under `scripts/` and `tests/governance/`. Scan roots are configured in
`governance/debt_config.yaml`:
